  ...
  return (
    ...
    >
      ...
      <p style={{ marginTop: "0.75rem", fontWeight: 300, letterSpacing: "0.04em" }}>
        <a href="https://github.com/Funghi88/Aegis-Vaults" target="_blank" rel="noopener noreferrer" className="link-hover" style={{ color: "var(--accent)" }}>
          GitHub
        </a>
        {" · "}
        <Link to="/security" className="link-hover" style={{ color: "var(--accent)" }}>
          Security
        </Link>
        {" · "}
