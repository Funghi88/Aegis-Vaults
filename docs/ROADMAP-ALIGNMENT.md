...
## 6. Future Features — Worth Adding

Features we plan to implement, with blockers and priorities.

### 6.1 High Priority

| # | Feature | Status | Blocker / Next Step |
|---|---------|--------|---------------------|
| **24** | Live performance metrics (APY, TVL, Users Saved) | APY ✅ | TVL and "Users Saved" need tracked data (DeFi Llama TVL, on-chain events). |
| **25** | Before/After demo (video + cost comparison) | Comparison table ✅ | Video is separate content; cost comparison text can be added. |

### 6.2 Medium Priority

| # | Feature | Blocker / Next Step |
|---|---------|---------------------|
| **1** | Simulate market crash demo | Needs `demoSetUnhealthy` in demo vault contract. |
| **5** | Gas estimation before XCM | Needs on-chain gas estimation. |
| **7** | One-click onboarding | Needs flow design (Connect → Approve → Auto-route). |

### 6.3 Lower Priority / Strategic

| # | Feature | Notes |
|---|---------|-------|
| **8–12** | Yield history, Mobile, Predictive routing, Dynamic risk, Notifications | Require historical data, PWA, ML, or infra. |
| **14–23** | Insurance fund, Audit transparency, SDK autoYield, DAO, Bridges, Fee structure, Tokenomics, Yield strategies, Social trading, Institutional | Strategic; design and product scope first. |

### 6.4 UX / Layout (Implemented)

| Item | Change |
|------|--------|
| Hero thumbnail space | Bottom padding increased 6rem → 10rem so divider sits lower and thumbnail has enough room. |
